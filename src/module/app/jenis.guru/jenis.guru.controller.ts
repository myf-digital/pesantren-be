...
export default class Controller {
  public async list(req: Request, res: Response) {
    try {
      const query = {
        nama_jenis_guru: req?.query?.nama_jenis_guru,
        lembaga_type: req?.query?.lembaga_type,
        id_tingkat: req?.query?.id_tingkat,
        id_guru: req?.query?.id_guru || req?.query?.id_pegawai,
      };
