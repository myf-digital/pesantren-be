...
import { variable } from './organitation.unit.variable';
import { response } from '../../../helpers/response';
import { repository } from './organitation.unit.repository';
import {
  ALREADY_EXIST,
  NOT_FOUND,
  SUCCESS_DELETED,
...
export default class Controller {
  public async list(req: Request, res: Response) {
    try {
      ...
      return helper.catchError(
        `organitation unit list: ${err?.message}`,
        500,
        res
      );
    }
  ...
  public async delete(req: Request, res: Response) {
    try {
      ...
      return helper.catchError(
        `organitation unit delete: ${err?.message}`,
        500,
        res
      );
    }
...
export const OrganitationUnit = new Controller();
